...
format: 
  revealjs:
    ...
    footer: Gerko Vink & the `mice` developers @ ITACOSM 2023, University of Calabria, Italy
---
...
::: footer
$^1$ See also [this link](https://thomvolker.github.io/ParamSynthMice/mice_param_synth.html) to Thom Volker's domain for a more extensive set of simulations
:::
